...
def get_best_homography(src_point, dst_point, src_img, dst_img, Hg_fitness_threshold=3, sum_threshold=0.01):
    # todo 论文中对应的惩罚项
    ...
    while True:
        ...
        warp_src_edge = cv2.Canny(gray_warp_src, 100, 200)
        warp_dst_edge = cv2.Canny(gray_warp_dst, 100, 200)
